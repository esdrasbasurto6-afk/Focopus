...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-05-2024 a las 10:43:46
...
(2, 'The Beatles', 300.00, 1, 'https://i.postimg.cc/G2x9vgQK/Beatles.jpg', 'esta camisa no le queda a cualquiera jajaj xd saludos'),
...
--
ALTER TABLE `camisetas`
  MODIFY `camiseta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `detalles_pedidos`
  MODIFY `detalle_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tallas`
  MODIFY `talla_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
